...
| 分支 | 位置 | 用途 | 当前状态 | 下一步 |
|---|---|---|---|---|
| `dev` | 本地 + `origin/dev`；仓库根目录 worktree | 日常开发与功能集成主线。新功能完成验收后先进入这里，再按发布流程进入 `main`。 | `开发中`；1.7.0 全渠道发布完成：Direct、官网、appcast 与 Homebrew 已于 2026-09-16 发布，App Store 已上线（2026-09-22 确认）。当前承载 1.8.0 发版准备。 | 继续 1.8.0 发版准备与后续新功能开发。 |
...
| `main` | 本地 + `origin/main`；仓库根目录 worktree | 远端默认稳定主线和发布基线。 | `长期保留`；1.7.0 已于 2026-09-15 推送 `main` 与 `v1.7.0`；Direct 公证、官网、appcast 与 Homebrew 已于 2026-09-16 完成，GitHub Release 已发布，App Store 已上线（2026-09-22 确认）。 | 保持 1.7.0 发布基线；1.8.0 在 `dev` 准备发版，完成后从已验收的 `dev` 快进。 |
