...
struct AgentTimelineProjectionTests {
    ...
    func buildsProcessAndResultLayers() {
        ...
        #expect(presentation.processSections[1].executionDetailItems.count == 2)
        #expect(presentation.processSections[1].aggregateStatus == .completed)
        #expect(presentation.processSections[1].knowledgeAuditToolCallID == nil)
